...
* [`skills/references/example-payloads.json`](skills/references/example-payloads.json) — real request/response examples for auth, market data, orders, and errors
* [`skills/references/workflows.md`](skills/references/workflows.md) — connect/trade/market-data checklists
